...
public class SoundFile {
    ...
    public void WriteFile(File outputFile, float startTime, float endTime)
        ...
        try {
            ...
            Log.e("Looper", "Failed to create the .m4a file.");
            Log.e("Looper", getStackTrace(e));
        }
    }
    ...
    private void DumpSamples(String fileName) {
        ...
        try {
            ...
            Log.w("Looper", "Failed to create the sample TSV file.");
            Log.w("Looper", getStackTrace(e));
        }
        // We are done here. Close the file and rewind the buffer.
        try {
            writer.close();
        } catch (Exception e) {
            Log.w("Looper", "Failed to close sample TSV file.");
            Log.w("Looper", getStackTrace(e));
        }
        mDecodedSamples.rewind();
    }
